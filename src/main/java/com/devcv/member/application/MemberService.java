...
*       updatePointByUserId: userID로 해당 회원 Point UPDATE,
*       ************************************ UPDATE ************************************
*
*   ********************************* MemberService 하위 메서드 기능 정리 *********************************
 */
...
public class MemberService {
    ...
    public int updatePointByUserId(Integer userpoint, Long userid){return memberRepository.updatePointByUserId(userpoint,userid);}
